...
import FamilyImg from "../assets/test_images/IMG-20231007-WA0009.jpg";
import TerritoryImg from "../assets/test_images/IMG-20231007-WA0015.jpg";
import BeautyImg from "../assets/test_images/IMG-20231007-WA0016.jpg";
import HumanismImg from "../assets/test_images/IMG-20240125-WA0031.jpg";
...
export default function DanilovIs() {
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="px-4 sm:px-6 lg:px-10 py-6 flex items-center justify-between border-b border-black/10">
                <h1 className="text-xs tracking-[0.32em] uppercase text-black">
                    {t.nav?.culture || "Culture"} / Danilov Is
                </h1>
                <button
                    type="button"
                    onClick={() => navigate(-1)}
